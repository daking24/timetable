                ...
                <form g-3 needs-validation method="Post" action="{{ route('courses.store') }}" class="form-sample">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6 col-md-6 mb-3">
                            ...
                            <input name="title" placeholder="Course Title" type="text" class="form-control" id="title" required />
                        ...
                        <div class="col-sm-12 col-lg-6 col-md-6 mb-3">
                            ...
                            <input name="code" placeholder="Course Code" type="text" class="form-control" id="code" required />
